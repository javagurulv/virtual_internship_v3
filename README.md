...
Не переживайте. Это дело поправимое. У нас есть отдельная программа, рассчитанная на обучение с нуля. Для освоения базовых знаний и получения практического опыта их применения вам потребуется 3 - 4 месяца упорной работы. Заинтересовало/хотите получить крепкие практические навыки применения Java Core и ООП? Напишите нам: javagurulv@gmail.com или в Telegram: @javagurulv.
